...
export class OrdensDeServicoAddEditPage implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.osForm = this.formBuilder.group({
      ...
      dataentrada: [{ value: this.ordemDeServico.dataehoraentrada.toLocaleDateString(), disable: !this.modoDeEdicao }, Validators.required],
      horaentrada: [{ value: this.ordemDeServico.dataehoraentrada.toLocaleTimeString(), disable: !this.modoDeEdicao }, Validators.required],
